...
# Generated on: Thu Jul 09 03:19:55 KST 2026 (Wed Jul 08 18:19:55 UTC 2026)
...
set logfile fv/counter_100/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/counter_100 -revised fv_map
...
read_library -liberty -both \
    /home/hah004/Basic_SoC-_Implementation/3_SYN/5_SYN/0_SAMPLE/../../1_LIB/slow_vdd1v0_basicCells.lib
...
add_search_path ../../../1_RTL/2_TINY_PROJECT -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k ../../../1_RTL/2_TINY_PROJECT/counter_100.v
elaborate_design -golden -root {counter_100} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/counter_100/fv_map.v.gz
elaborate_design -revised -root {counter_100}
...
#add_name_alias fv/counter_100/fv_map.singlebit.original_name.alias.json.gz -revised
...
write_compared_points noneq.compared_points.counter_100.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.counter_100.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.counter_100.rtl.fv_map.rpt
